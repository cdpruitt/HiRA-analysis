...
histo_sort::histo_sort()
{
  ...
  T_RFSCIN = new TH1I("T_RFSCIN","",1024,-600,400);
  T_RFCYC = new TH1I("T_RFCYC","",1024,-600,400);
  T_A1900 = new TH1I("T_A1900","",1024,-600,400);
...
// 	CaldEE[icsi] = new TH2I(name.c_str(),"",1600,0,800,1024,0,80);
  ...
  EfrontR = new TH1I**[Ntele];
  EfrontC = new TH1I**[Ntele];
  EfrontLR = new TH1I**[Ntele];
  EfrontLC = new TH1I**[Ntele];
  TfrontR = new TH1I**[Ntele];

  EbackR  = new TH1I**[Ntele];
  EbackC  = new TH1I**[Ntele];
  EbackLR = new TH1I**[Ntele];
  EbackLC = new TH1I**[Ntele];
  TbackR  = new TH1I**[Ntele];
  
  
  FBMult = new TH2I*[Ntele];

  EFCSum = new TH2I*[Ntele];
  EBCSum = new TH2I*[Ntele];
  EFSum = new TH2I*[Ntele];
  EBSum = new TH2I*[Ntele];

  
  dirSum->cd();
  EFTSum = new TH2I*[Ntele];
  EBTSum = new TH2I*[Ntele];
  ...
  for (int itele=0;itele<Ntele;itele++)
    {
      EfrontR[itele] = new TH1I*[Nstrip];
      EfrontC[itele] = new TH1I*[Nstrip];
      EfrontLR[itele] = new TH1I*[Nstrip];
      EfrontLC[itele] = new TH1I*[Nstrip];
      TfrontR[itele] = new TH1I*[Nstrip];
            
      EbackR[itele]  = new TH1I*[Nstrip];
      EbackC[itele]  = new TH1I*[Nstrip];
      EbackLR[itele]  = new TH1I*[Nstrip];
      EbackLC[itele]  = new TH1I*[Nstrip];
      TbackR[itele]  = new TH1I*[Nstrip];
